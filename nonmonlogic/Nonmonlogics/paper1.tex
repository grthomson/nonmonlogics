...
primitive base consequence relation which is assumed to be nonmonotonic. The sequent calculus naturally gives rise to decorated and labelled rooted trees, while the inadmissibility of the Weakening rule requires us to define a grafting operation whose constraints encode constrained proof composition. We define a proof-theoretically meaningful equivalence relation which identifies proof-trees differing
...
The aim of this paper is to define a proof-theoretically meaningful algebraic structure from proof composition
in a setting where monotonicity and familiar structural rules are not built in
