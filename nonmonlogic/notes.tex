...
Note: bitter lesson / compositional semantics paper was Wang-Masciana.

consider also explosion over state updates: ``how the acceptable or applicable inferences appear (logically) at each state update. so i guess we do want to keep previous inferences. my worry is that we end up e.g. arriving at strict logical inconsistencies" some kind of paraconsistency needed here? 
\end{document}